...
class PurchaseItem(BaseModel):
    ...
    def unit_price(self):
        ...
        self.total_price = to_decimal(self.total_price)
        return self.total_price / self.quantity if self.quantity > 0 else Decimal("0")
...
class Stock(BaseModel):
    ...
    quantity = models.DecimalField(
        "Quantidade em estoque", max_digits=10, decimal_places=3, default=0
    )
    ...
    def current_value(self):
        return to_decimal(self.quantity) * to_decimal(self.ingredient.cost_per_unit)
